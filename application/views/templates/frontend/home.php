...
<section class="hero is-medium is-success voting">
    <div class="hero-body">
        <div class="container">
            <h3 class="title">Bakal naro module Voting di sini</h3>
            <h4 class="subtitle">Tapi masih bingung user interface nya</h4>
        </div>
    </div>
</section>
