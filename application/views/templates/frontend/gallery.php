        ...
        <div class="columns">
            <div class="column is-one-third">
                ...
                <div class="ui styled accordion">
                    ...
                    <!-- Awak comment dulu ya. Nak awak inspect pake versi static dulu  -->
                    <!-- <?php
                    // if(!empty($list_month_gallery)){
                    //     foreach ($list_month_gallery as $key => $month) {
                    ...
                    <div class="ui menu content">
                        <ul>
                            <li>
                                <a href="#" class="item" data-tab="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan">Nyat Kadir gelar buka bersama dengan anak jalanan</a>
                            </li>
                            <li>
                                <a href="#" class="item" data-tab="besar_besaran_kata">Besar-besaran Kata</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="column">
                <div class="gallery-wrapper">
                    ...
                    <!-- Dinamisnya awak comment dulu ya wak. Awak coba inspect di static nya dulu -->
                    <!-- <?php
                    // foreach ($listgallery as $keying => $gallery) {
                    ...
                    <div class="ui tab hero is-primary active" data-tab="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan">
                        <div class="hero-body">
                            <h1 class="title">Nyat Kadir gelar buka bersama dengan anak jalanan</h1>
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/slide1.jpg" data-fancybox="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan" data-caption="Nyat Kadir Gelar Buka Bersama">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/slide1.jpg" alt="">
                                    </div>
                                    <h4>Perjalanan Menuju Pulau Setokok</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/sushi-man-edited.jpg" data-fancybox="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan" data-caption="Nyat Kadir Gelar Buka Bersama">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/sushi-man-edited.jpg" alt="">
                                    </div>
                                    <h4>Sampai di Panti Pulau Setokok</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/campaign.jpg" data-fancybox="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan" data-caption="Nyat Kadir Gelar Buka Bersama">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/campaign.jpg" alt="">
                                    </div>
                                    <h4>Bersalaman dengan Panti Pulau Setokok</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir1.jpg" data-fancybox="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan" data-caption="Nyat Kadir Gelar Buka Bersama">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir1.jpg" alt="">
                                    </div>
                                    <h4>Beramah-tamah dengan Panti Pulau Setokok</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir2.jpg" data-fancybox="nyat_kadir_gelar_buka_bersama_dengan_anak_jalanan" data-caption="Nyat Kadir Gelar Buka Bersama">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir2.jpg" alt="">
                                    </div>
                                    <h4>Beramah-tamah dengan Panti Pulau Setokok</h4>
                    ...
                    <div class="ui tab hero is-primary" data-tab="besar_besaran_kata">
                        <div class="hero-body">
                            <h1 class="title">Demi Bangsa dan Indonesia</h1>
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/campaign.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/campaign.jpg" alt="">
                                    </div>
                                    <h4>Perjalanan Menuju Panti Asuhan Aini</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir1.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir1.jpg" alt="">
                                    </div>
                                    <h4>Sampai di Panti Asuhan Aini</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/slide1.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/slide1.jpg" alt="">
                                    </div>
                                    <h4>Bersalaman dengan Panti Asuhan Aini</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/sushi-man-edited.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/sushi-man-edited.jpg" alt="">
                                    </div>
                                    <h4>Beramah-tamah dengan Panti Asuhan Aini</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/road-forest.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/road-forest.jpg" alt="">
                                    </div>
                                    <h4>Beramah-tamah dengan Panti Asuhan Aini</h4>
                            ...
                            <div class="box">
                                <a href="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir2.jpg" data-fancybox="besar_besaran_kata" data-caption="Besar-besaran Kata">
                                    <div class="image">
                                        <img src="<?php echo base_url().$this->data['asfront'];?>img/nyatkadir2.jpg" alt="">
                                    </div>
                                    <h4>Beramah-tamah dengan Panti Asuhan Aini</h4>
